...
# -*- coding: utf-8 -*-
# ===================================================
# 8021aqView_v5.0 - created by Benjamin Domroese in 2021.
#
...
# v3_0: Add Menu 23 and 24, for statistics about which ISIDs a specific
#       edge traverse.
# v4_0: Added set_isids_in_use, to adapt Menu 21 to 24 for
#       BVLAN and ISID display filter.
# v5_0: Added plausibility check for duplicate ISIDs on one node.
